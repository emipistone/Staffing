        ...
        return {
            ...
            setSkin: function(id) {
                ...
                if(useSkinCookie) {
                    ...
                    var staffingTrackerSkin = $cookies.get('staffingTracker-skin');
                    if(angular.isDefined(staffingTrackerSkin)) {
                        var cookieTheme = angular.fromJson(staffingTrackerSkin);
