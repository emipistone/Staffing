---
  ...
  subtitle: Lists all changes to each version of staffingTracker
  layout: docs.hbs
---
...
- StaffingTracker moved into a module to make it easier to drop the code into existing apps or creating new ones
...
- Moved font family CSS into app.scss from staffingTracker module.
